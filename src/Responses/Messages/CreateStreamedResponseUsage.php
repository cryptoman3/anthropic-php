<?php                                                                                                                                                                                                                                                                                                                     
  ...
  final class CreateStreamedResponseUsage
  {
      ...
      /**
       * @param  array{input_tokens?: int, output_tokens?: int, cache_read_input_tokens?: int, cache_creation_input_tokens?: int}  $attributes
       */                                                                                                                                                                                                                                                                                                                   
      ...
      /**
       * @return array{input_tokens: int|null, output_tokens: int|null, cache_read_input_tokens: int|null, cache_creation_input_tokens: int|null}
       */                                                                                                                                                                                                                                                                                                                   
